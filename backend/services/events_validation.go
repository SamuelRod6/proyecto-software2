// File: backend/services/events_validation.go
...
func ValidateEventoFechas(fechaInicio, fechaFin, fechaCierre string, now time.Time) (time.Time, time.Time, time.Time, error) {
	...
	// Cierre de inscripcion debe ser despues de la fecha actual
	...
	// Cierre de inscripcion debe ser antes del inicio del evento
