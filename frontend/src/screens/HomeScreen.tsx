...
export default function HomeScreen(): JSX.Element {
	return (
		<section className="min-h-screen h-full bg-slate-900 text-white flex flex-col items-center justify-center px-4">
			<h1 className="text-4xl font-bold mb-4 text-[#F5E427] drop-shadow text-center">
				Bienvenido al Sistema <br />
				Automatizado de Gestión de Eventos Científicos
			</h1>
			<div className="rounded-xl bg-slate-800/80 p-6 shadow-lg max-w-lg w-full mb-6 flex flex-col items-center text-center">
				<p className="text-slate-200">
					Por favor, navega a la sección de eventos para ver la funcionalidad principal de la aplicación.
				</p>
				<Link
					to={ROUTES.events}
